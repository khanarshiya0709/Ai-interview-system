            ...
            <div className="relative w-[85%] sm:w-[90%] max-w-[900px] sm:h-[480px] overflow-hidden rounded-[40px] sm:rounded-4xl shadow-xl flex flex-col sm:flex-row bg-white">
                ...
                <div className={`bg-white w-full sm:w-2/4 flex flex-col gap-3 p-6 justify-center transition-all duration-500 sm:duration-700
                    ...
                    <div className="relative">
                        ...
                        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-purple-500"><FaUser /></span>
                    </div>
                    <div className="relative">
                        ...
                        <span className="absolute right-4 top-1/2 -translate-y-1/2"><MdEmail /></span>
                    </div>
                    <div className="relative">
                        ...
                        <span className="absolute right-4 top-1/2 -translate-y-1/2"><RiLockPasswordFill /></span>
                    </div>
                    <button className="bg-purple-500 rounded-lg py-2 text-white font-semibold hover:bg-purple-600 transition-colors">Register</button>
                    <div className='flex justify-center gap-4 mt-2'>
                        <button className='p-3 border rounded-xl shadow-sm hover:bg-gray-50'><FaGoogle /></button>
                        <button className='p-3 border rounded-xl shadow-sm hover:bg-gray-50'><FaLinkedinIn /></button>
                    </div>
                </div>
                ...
                <div className={`absolute sm:relative bg-white w-full sm:w-2/4 h-full flex flex-col gap-4 p-6 justify-center transition-all duration-500 sm:duration-700
                    ...
                    <h1 className="font-bold text-2xl sm:text-4xl text-center mb-2 mt-[160px] sm:mt-0">Login</h1>
                    <div className="relative">
                        ...
                        <span className="absolute right-4 top-1/2 -translate-y-1/2"><FaUser /></span>
                    </div>
                    <div className="relative">
                    ...
                    <button className="bg-blue-500 rounded-lg py-2 text-white font-semibold hover:bg-blue-600 transition-colors">Login</button>
                    <div className='flex justify-center gap-6'>
                        <button className='p-4 border rounded-xl shadow-sm hover:bg-gray-50'><FaGoogle /></button>
                        <button className='p-4 border rounded-xl shadow-sm hover:bg-gray-50'><FaLinkedinIn /></button>
                    </div>
                </div>

                {/* ================= SLIDING PANEL (Purple) ================= */}
...
`}>
                    ...
                    <h1 className="text-2xl font-bold">{isLogin ? "Hello, Welcome!" : "Welcome Back!"}</h1>
                    <p className="text-sm mb-2">{isLogin ? "Don't have an account?" : "Already have an account?"}</p>
                    <button onClick={() => setIsLogin(!isLogin)} className="border-2 border-white rounded-xl px-8 py-1.5 hover:scale-105 transition font-bold">
